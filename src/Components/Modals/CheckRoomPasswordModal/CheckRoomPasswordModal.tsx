...
const CheckRoomPasswordModal: FC<IModalProps> = ({
  isVisible,
  onClose,
  room,
}) => {
    ...
    <Modal
      ...
      <View style={styles.container}>
        <Text style={styles.text}>
          The room is private. Please enter the room's password.
        </Text>
        <InputBox
          iconName="lock"
        ...
        />
        {error ? (
          <Text style={styles.errorText}>Password is wrong.</Text>
        ) : null}
        <MainButton title="Go the Room" onPress={checkPassword} />
      </View>
    </Modal>
  );
};
