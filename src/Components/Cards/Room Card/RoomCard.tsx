    ...
    <TouchableWithoutFeedback onPress={onPress}>
      <View style={styles.container}>
        <View style={styles.roomAccessContainer}>
          {room.isPrivate ? (
            <Icon name="lock" size={15} color={Colors.darkGreen} />
          ) : (
            <Icon name="lock-open-variant" size={15} color={Colors.darkGreen} />
          )}
        </View>
        ...
        <View style={styles.innerContainer}>
          <Icon name="account-group" size={25} color={Colors.iconColor} />
