            ...
            <View style={styles.innerContainer}>
                ...
                {({values,handleChange,handleSubmit})=>
                    <>
                        ...
                        <MainButton title='Login' onPress={handleSubmit} loading={loading}></MainButton> 
                    </>
                }
                ...
                <View style={styles.choiceContainer}>
                    ...
                    <Text style={styles.justSearchText} onPress={()=>navigation.navigate('SearchWithoutLogin')}>I just want to search for nutritional values.</Text>
                </View>
