    ...
    return(
        ...
        <Tab.Navigator screenOptions={{headerShown:false}}>
            <Tab.Screen name="Home" component={HomePage} options={{
                        tabBarLabel: ({ focused }) => {
                            return <Text style={{color: focused ? Colors.darkGreen : Colors.menuGrey, fontFamily:Fonts.defaultRegularFont}}>Home</Text>
                          },
                       tabBarIcon: ({ focused }) => {
                          return (
                            <View>
                              <Icon name='home' size={25} color={focused? Colors.darkGreen : Colors.menuGrey}></Icon>
                            </View>
                          );
                        },
                  }} />
            <Tab.Screen name="Search" component={SearchPage} options={{
                        tabBarLabel: ({ focused }) => {
                            return <Text style={{color: focused ? Colors.darkGreen : Colors.menuGrey, fontFamily:Fonts.defaultRegularFont}}>Search</Text>
                          },
                       tabBarIcon: ({ focused }) => {
                          return (
                            <View>
                              <Icon name='magnify' size={25} color={focused? Colors.darkGreen : Colors.menuGrey}></Icon>
                            </View>
                          );
                        },
                  }}/>
            <Tab.Screen name="ForumStack" component={LoginnedUserForumStack} options={{
                       ...
                       tabBarIcon: ({ focused }) => {
                          return (
                            <View>
                              <Icon name='forum' size={25} color={focused? Colors.darkGreen : Colors.menuGrey}></Icon>
                            </View>
                          );
                        },
                  }}/>
            <Tab.Screen name="Profile" component={ProfilePage} options={{
                        tabBarLabel: ({ focused }) => {
                            return <Text style={{color: focused ? Colors.darkGreen : Colors.menuGrey, fontFamily:Fonts.defaultRegularFont}}>Profile</Text>
                          },
                       tabBarIcon: ({ focused }) => {
                          return (
                            <View>
                              <Icon name='account' size={25} color={focused? Colors.darkGreen : Colors.menuGrey}></Icon>
                            </View>
                          );
                        },
                  }}/>
